//
// Created by maruthinh on 9/5/18.
//
...
/****dissipative flux****/
        ...
        fdiss1 = Movers(rhour, rhoul, rhor, rhol, L_max, L_min);
        fdiss2 = Movers(pr + rhour*ur, pl + rhoul*ul, rhour, rhoul, L_max, L_min);
        fdiss3 = Movers(rhour*hr, rhoul*hl, rhor*Er, rhol*El, L_max, L_min);

        /*fdiss1 = MoversWEF(rhour, rhoul, rhor, rhol, L_max, L_min);
        fdiss2 = MoversWEF(pr + rhour*ur, pl + rhoul*ul, rhour, rhoul, L_max, L_min);
        fdiss3 = MoversWEF(rhour*hr, rhoul*hl, rhor*Er, rhol*El, L_max, L_min);*/
...
/*		fdiss1 = Movers(rhour*hr, rhoul*hl, rhor*Er, rhol*El, L_max, L_min)*(rhor-rhol);
        ...
        fdiss3 = Min3(fdiss1, fdiss2, fdiss3);

        iflux[0][i] = 0.5*(fconv1-fdiss3*(rhor-rhol));
        iflux[1][i] = 0.5*(fconv2-fdiss3*(rhour-rhoul));
        iflux[2][i] = 0.5*(fconv3-fdiss3*(rhor*Er-rhol*El));
